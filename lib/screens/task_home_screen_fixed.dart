...
// import 'package:planno/viewmodels/task_viewmodel.dart';
...
//     await taskViewModel.toggleTaskStatus(taskId, true);
//   }

//   String _getMotivationalMessage(double progress) {
//     final percentage = (progress * 100).round();
//     if (percentage == 100) return 'All tasks completed! 🎉';
//     if (percentage >= 81) return 'Amazing work! Finish strong 💯';
//     if (percentage >= 51) return r"Great job! You're more than halfway 🔥";
//     if (percentage >= 21) return 'Good progress, keep going 🚀';
//     return 'Lets get started 💪';
//   }

//   String _getSecondaryMessage(double progress) {
//     final percentage = (progress * 100).round();
//     if (percentage == 100) return 'You crushed todays goals 👏';
